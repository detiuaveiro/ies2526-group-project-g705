...
export const BreakdownHistory: React.FC = () => {
  // Agrupar falhas por máquina
  const breakdownsByMachine = mockMachines.map(machine => {
    const machineBreakdowns = mockBreakdowns
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6">
        {breakdownsByMachine.map(({ machine, breakdowns, totalBreakdowns, unresolvedCount }) => (
          <Card key={machine.id}>
            <CardHeader>
