...
const mockMachines = [
  {
    ...
    pressure: 120,
    temperature: 95,
    lastMaintenance: /* @__PURE__ */ new Date("2026-02-28"),
  ...
  },
  {
    ...
    pressure: 95,
    temperature: 75,
    lastMaintenance: /* @__PURE__ */ new Date("2026-03-01"),
    assignedTechnicians: ["1"]
  },
  {
    id: "M003",
    ...
    pressure: 70,
    temperature: 55,
    lastMaintenance: /* @__PURE__ */ new Date("2026-03-03")
  },
  {
    id: "M004",
    ...
    pressure: 140,
    temperature: 105,
    lastMaintenance: /* @__PURE__ */ new Date("2026-02-15"),
    assignedTechnicians: ["1"]
  },
  {
    id: "M005",
    ...
    pressure: 75,
    temperature: 60,
    lastMaintenance: /* @__PURE__ */ new Date("2026-03-04")
  },
  {
    id: "M006",
    name: "Turbine F1",
    ...
    pressure: 100,
    temperature: 80,
    lastMaintenance: /* @__PURE__ */ new Date("2026-02-25")
  }
];
...
const mockBreakdowns = [
  {
    id: "B001",
    machineId: "M001",
    date: /* @__PURE__ */ new Date("2026-02-28"),
  ...
  },
  {
    id: "B002",
    machineId: "M001",
    date: /* @__PURE__ */ new Date("2026-02-15"),
  ...
  },
  {
    id: "B003",
    machineId: "M001",
    date: /* @__PURE__ */ new Date("2026-01-20"),
  ...
  },
  {
    id: "B008",
    machineId: "M006",
    date: /* @__PURE__ */ new Date("2026-02-25"),
...
const mockAssistanceRequests = [
  {
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-05T10:30:00"),
    status: "pending"
  },
  {
    id: "AR002",
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-16T08:15:00"),
    status: "pending"
  },
  {
    id: "AR003",
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-16T09:45:00"),
    status: "pending",
  ...
  },
  {
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-15T14:20:00"),
    status: "pending",
    assignedTechnicians: ["1"]
  },
  {
    ...
    requestedBy: "John Smith",
    timestamp: /* @__PURE__ */ new Date("2026-03-15T16:10:00"),
    status: "resolved",
    assignedTechnicians: ["1"]
  },
  {
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-14T11:05:00"),
    status: "pending"
  },
  {
    id: "AR007",
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-14T13:30:00"),
    status: "pending",
  ...
  },
  {
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-13T09:20:00"),
    status: "resolved",
  ...
  },
  {
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-12T15:45:00"),
    status: "pending"
  },
  {
    id: "AR010",
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-11T10:15:00"),
    status: "pending",
    assignedTechnicians: ["3"]
  },
  {
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-10T14:30:00"),
    status: "resolved",
    assignedTechnicians: ["1"]
  },
  {
    ...
    timestamp: /* @__PURE__ */ new Date("2026-03-10T08:00:00"),
    status: "pending"
  },
  {
    id: "AR013",
    ...
    requestedBy: "John Smith",
    timestamp: /* @__PURE__ */ new Date("2026-03-09T11:20:00"),
    status: "pending",
    assignedTechnicians: ["3"]
  },
  {
    ...
    requestedBy: "Ana Costa",
    timestamp: /* @__PURE__ */ new Date("2026-03-08T16:40:00"),
    status: "pending"
  },
  {
    id: "AR015",
    ...
    requestedBy: "Lisa Anderson",
    timestamp: /* @__PURE__ */ new Date("2026-03-08T09:10:00"),
    status: "resolved",
    assignedTechnicians: ["5"]
  },
  {
    ...
    requestedBy: "Robert Wilson",
    timestamp: /* @__PURE__ */ new Date("2026-03-07T13:25:00"),
    status: "pending",
    assignedTechnicians: ["1"]
  },
  {
    ...
    requestedBy: "John Smith",
    timestamp: /* @__PURE__ */ new Date("2026-03-06T10:00:00"),
    status: "pending"
  },
  {
    id: "AR018",
    ...
    requestedBy: "Ana Costa",
    timestamp: /* @__PURE__ */ new Date("2026-03-05T15:50:00"),
    status: "resolved",
    assignedTechnicians: ["3"]
  },
  {
    ...
    requestedBy: "Lisa Anderson",
    timestamp: /* @__PURE__ */ new Date("2026-03-04T08:30:00"),
    status: "pending"
  },
  {
    id: "AR020",
    ...
    requestedBy: "Robert Wilson",
    timestamp: /* @__PURE__ */ new Date("2026-03-03T14:15:00"),
    status: "pending",
    assignedTechnicians: ["3"]
  }
];
