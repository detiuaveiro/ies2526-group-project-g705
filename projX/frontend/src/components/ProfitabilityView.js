...
const ProfitabilityView = () => {
  ...
  }).filter((item) => item.breakdownCount > 0).sort((a, b) => b.totalCost - a.totalCost);
  ...
  return <div className="space-y-6">
    ...
    /* Detalhes por Máquina */
      ...
      <div className="grid gap-6">
        {machineStats.map(({ machine, breakdownCount, totalCost: totalCost2, totalTime, breakdowns }) => <Card key={machine.id}>
            <CardHeader>
            ...
            <CardContent>
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {breakdowns.map((breakdown) => <tr key={breakdown.id} className="border-b hover:bg-gray-50">
